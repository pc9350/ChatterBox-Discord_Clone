...
export default function SignInPage() {
  return (
    <div className="flex h-screen w-full bg-[#080a12] overflow-hidden relative">
      ...
      {/* Gradient orbs */}
      <div className="absolute top-[-15%] left-[-8%] w-[600px] h-[600px] rounded-full bg-indigo-600/15 blur-[130px] pointer-events-none" />
      <div className="absolute bottom-[-15%] right-[-8%] w-[500px] h-[500px] rounded-full bg-violet-600/10 blur-[110px] pointer-events-none" />
      ...
      >
        ...
        <p className="text-slate-400 text-lg max-w-sm mb-14 leading-relaxed">
          Real-time messaging, friends, and file sharing — all in one place.
        </p>
